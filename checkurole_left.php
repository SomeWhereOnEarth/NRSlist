...
?>
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold"><u>จ่าเวรนักเรียนปกครองกราบซ้าย</u></p>
        </div>
        <p class="font-weight-bold text-danger h2"><u>กรุณาใส่เลข 8 แทน no</u></p>
        ...
        <div class="charts-1">
            ...
            <form action="checkurole_1.php" name="add_name" id="add_name" method="post">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php 
                      $stmt = $conn->query("SELECT * FROM student_data WHERE position = 'command' ");
                      $stmt->execute();
                      $users = $stmt->fetchAll();
