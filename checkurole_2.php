...
?>
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold"><u>จ่าเวรนักเรียนภาค 2</u></p>
        </div>
        <p class="font-weight-bold text-danger h2"><u>กรุณาใส่เลข 2 แทน no</u></p>

        <div class="charts-1">
            <div class="charts-card">
            <form action="checkurole_2.php" name="add_name" id="add_name" method="post">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php 
                      $stmt = $conn->query("SELECT * FROM student_data WHERE company = '2' AND position = 'second' ");
                      $stmt->execute();
                      $users = $stmt->fetchAll();
